...
dataset_arg.add_argument("--v_net_setting_num_v_nets", type=int, default=1000, help="")
dataset_arg.add_argument("--v_net_setting_v_net_size_low", type=int, default=2, help="")
dataset_arg.add_argument(
...
# rl
rl_arg.add_argument(
    "--rl_gamma", type=float, default=0.99, help="Cumulative reward discount rate"
)
...
rl_arg.add_argument(
    "--lr_critic", type=float, default=1e-3, help="Critic learning rate"
)
rl_arg.add_argument(
    "--lr_penalty_params", type=float, default=1e-1, help="Penalty learning rate"
)
rl_arg.add_argument(
    "--compute_cost_method",
    type=str,
    default="reachability",
    help="Cost computing method",
)

### FlagVNE ###
flag_vne_arg = parser.add_argument_group("flag_vne")
flag_vne_arg.add_argument(
    "--num_meta_learning_epochs",
    type=int,
    default=50,
    help="Number of meta learning epochs",
)
flag_vne_arg.add_argument(
    "--infer_with_single_task_policy_id",
    type=int,
    default=0,
    help="Whether to use single task policy to infer",
)
flag_vne_arg.add_argument(
    "--use_bidirectional_action",
    type=str2bool,
    default=True,
    help="Whether to use bidirectional action",
)
flag_vne_arg.add_argument(
    "--use_meta_learning",
    type=str2bool,
...
flag_vne_arg.add_argument(
    "--use_curriculum_scheduling_strategy",
    type=str2bool,
    default=False,
    help="Whether to use curriculum scheduling strategy",
)
flag_vne_arg.add_argument(
    "--policy_entropy_threshold",
    type=float,
    default=2.0,
    help="policy entropy threshold for curriculum scheduling strategy",
)
...
train_arg.add_argument(
    ...
    type=int,
    default=1,
    help="Number of workers to distributedly train",
)
train_arg.add_argument(
    "--batch_size", type=int, default=128, help="Batch size of training"
)
train_arg.add_argument(
    "--target_steps",
    type=int,
...
train_arg.add_argument(
    "--k_shortest", type=int, default=10, help="k param for k_shortest"
)
